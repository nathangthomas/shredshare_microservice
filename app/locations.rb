...
cities = ['Denver,CO', 'Lakewood,CO', 'Arvada,CO']
# 'Westminster,CO', 'Wheat Ridge,CO', 'Golden,CO', 'Edgewater,CO', 'Mountain View,CO', 'Bow Mar,CO', 'Littleton,CO', 'Superior,CO', 'Lakeside,CO'
